...
다만 70~80%는 측정 방법이 공개된 독립 감사 수치가 아니라 회사 임원의 설명입니다. 그리고 공개된 자료만으로 AI가 감축의 유일한 원인이라고 단정할 수도 없습니다.
...
이번 보도가 보여주는 변화는 코딩이 사라진다는 단순한 이야기가 아닙니다. **코드를 직접 만드는 시간의 비중이 줄수록, 무엇을 만들지 정하고 결과를 검증하며 책임지는 역량의 가치가 커지는 방향**에 가깝습니다. 실제 감축 규모와 250명 순증 채용 계획의 이행 여부는 후속 공개를 확인해야 합니다.
...
회사는 향후 2년 동안 250개가 넘는 엔지니어링 직무를 `순증` 채용할 계획이라고 밝혔습니다. 하지만 미래 계획이므로 실제 완료 여부와 조직별 배치는 아직 확인할 수 없습니다.
