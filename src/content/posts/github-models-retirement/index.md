...
GitHub는 완전 종료 전에 2026년 7월 16일과 23일 짧은 brownout을 진행한다고 밝혔습니다. 이 시간에는 GitHub Models 요청이 일시적으로 오류를 반환한 뒤 복구됩니다. 현재 API 호출이나 데모가 GitHub Models에 의존한다면 두 날짜 전에 의존 지점과 오류 처리 동작을 점검하는 편이 안전합니다.
